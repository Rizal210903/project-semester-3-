...
$dashboard_pages = [
    'manage-pbdb.php', 'galeri.php', 'manage_agenda.php',
    'manage_payments.php', 'manage_teachers.php',
    'manage_admin.php', 'manage_pbdb_info.php'
];
...
.sidebar a {
    display: flex;
    align-items: center;
    white-space: nowrap; /* <<< FIX TEKS MELEBAR */
            ...
            <ul class="submenu">
                ...
                <li>
                    <a href="manage_teachers.php" class="<?= $current_page == 'manage_teachers.php' ? 'active' : '' ?>">
                        ...
                        <span>Manajemen Absen Guru</span>
                    </a>
                </li>
