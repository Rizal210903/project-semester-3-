...
<head>
    ...
    <style>
        ...
        .hero-section div {
            ...
            background: rgba(180, 243, 251, 0.8);
        }
        .info-section { background: #E0F7FA; padding: 40px 0; }
        .card-info { background: #fff; border: 2px solid #45B7D1; border-radius: 10px; padding: 20px; }
        .dropdown-menu {
            background: #E0F7FA; border: 2px solid #45B7D1; border-radius: 10px;
...
<body>
    <main class="container-fluid p-0">
        ...
        <section class="hero-section text-center py-5">
            ...
            <div class="container py-5 position-relative">
                <h1 class="display-4 text-primary animate__animated animate__fadeIn" style="font-family: 'Poppins', sans-serif;">Info PPDB TK Pertiwi</h1>
                <p class="lead text-white animate__animated animate__fadeIn" style="animation-delay: 0.2s;">Informasi Penerimaan Peserta Didik Baru Tahun 2025/2026</p>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-info mb-4 animate__animated animate__fadeInUp">
                            <h2 class="text-center mb-4" style="color: #0dcaf0; font-size: clamp(1.2rem, 3vw, 1.8rem);">Jadwal PPDB</h2>
                        ...
                        <div class="card-info animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                            <h2 class="text-center mb-4" style="color: #0dcaf0; font-size: clamp(1.2rem, 3vw, 1.8rem);">Syarat Pendaftaran</h2>
                            <ul class="list-group list-group-flush">
                                <?php if (empty($syarat)): ?>
    ...
    <footer class="text-center py-3" style="background: #e2e7e8ff; color: #007bff;">
        <p>&copy; 2025 TK Pertiwi</p>
    </footer>
